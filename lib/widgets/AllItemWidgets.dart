...
class AllItemWidgets extends StatefulWidget {
  AllItemWidgets({Key? key}) : super(key: key);

  @override
  _AllItemWidgetsState createState() =>
      _AllItemWidgetsState();
}

class _AllItemWidgetsState extends State<AllItemWidgets> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        foregroundColor: Color.fromARGB(255, 68, 219, 194),/* GlobalVariables.fromHex('#42C2FF'), */
                                        ...
                                        child: Container(
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              Icon(
                                                Icons.room,
                                                color: Color.fromARGB(255, 68, 219, 194),/* GlobalVariables.fromHex(
                                                    '#42C2FF'), */
                                                size: 15,
                                              ),
                                              Text(
